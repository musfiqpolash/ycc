    ...
    <div class="row marginTop">
        <div id="lower" class="col-md-5 col-md-push-7 backgroundGrey sticky">
                ...
                <div class="col-md-12">
                    <div class="row marginBottom">
                        <div class="col-md-4 col-xs-4">
                            <img src="images/1.png" alt="1" class="img-thumbnail">
                        </div>
            ...
            <div class="row marginBottom">
                ...
                <div class="col-md-12">
                    <p>Subtotal <span class="pull-right">$798</span></p>
                    <p>Shipping <span class="pull-right">$15</span></p>
                    <p>Sales Tax <span class="pull-right">$3.90</span></p>
                    <h4><b>Total <span class="pull-right">$816.90</span></b></h4>
                </div>
            </div>
        </div>
        <div id="upper" class="col-md-7 col-md-pull-5">
            <form id="form" action="">
                <h3>1. Shipping Details <span class="pull-right edit1"><small><a class="color">Edit</a></small></span></h3>
                ...
                <h3>2. Delivery Method<span class="pull-right edit2"><small><a class="color">Edit</a></small></span></h3>
                ...
                <div class="row paymentDetails">
                    <div class="col-md-12">
                        <div class="radio">
                            ...
                            <span class="pull-right"><img src="images/creditCard.svg" alt="credit card"></span>
                        </div>
                        <div class="radio">
                            <label for="paypal">
                            ...
                            <span id="paypalImg" class="pull-right"><img src="images/payPal.svg" alt="payPal"></span>
                        </div>
                    </div>
            ...
            <div class="well text-center warning-div">
                ...
                <p>We weren't able to process your transaction. Please review your payment details and try again in a few minutes.</p>
