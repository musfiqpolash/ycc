...
@section('content')
<form action="{{ url('admin/request_brand/store') }}" method="post" enctype="multipart/form-data">
    {{ csrf_field() }}
    <div class="panel panel-default">
        <div class="panel-heading">Add Taking Order Sliders</div>
        <div class="panel-body">
            <div class="form-group {{$errors->has('image')?'has-error':''}}">
                <label for="image" class="control-label">Image <sub>*Image will be resized to 130x100 px</sub></label>
