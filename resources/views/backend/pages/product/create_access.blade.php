    ...
    <script>
							...
							`<tr id="row_${i}">
                                ...
                                <td>
                                    <select name="condition[${i}]" id="condition_${i}" class="form-control">
                                        <option value="GRADE A">GRADE A</option>
                                        <option value="GRADE B">GRADE B</option>
                                        <option value="GRADE B">GRADE C</option>
                                    </select>
                                </td>
                                <td>
								...
								<table class="table table-bordered">
									...
									<tr>
										...
										<td colspan="2">
											...
											<input type="hidden" name="max_quantity[${flag}][]" id="max_quantity_${flag}_0" placeholder="max quantity" value="1">
										</td>
        ...
        function samePrice(t, r) {
           if($(t).is(':checked')){
               ...
               $('#price_table_'+r+' *').filter(':input:not([readonly])').each(function () {
				   $(this).attr('value','1');
               });
		   }else {
