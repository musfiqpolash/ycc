...
@section('content')
            ...
            <div class="panel-body">
                ...
                <div class="row">
                    <div class="form-group col-md-6">
                        ...
                        <div>
                            <input onblur="chk(this.id)" required type="text" class="form-control" id="product_name"
                                   name="product_name"
                ...
                <div class="">
                    <div class="table-responsive">
                        <table class="table table-bordered table-striped mb-none" id="example">
                            <thead>
                            <tr>
                                <th style="width: 3%"><label class="label label-primary"><i
                            ...
                            <tr>
                                <td style="width: 3%">
                                    <label class="label label-primary"><i class="fa fa-plus"></i></label>
                                </td>
                                <td style="width: 8%">
    ...
    <div class="row">
        ...
        <div id="wait"
            ...
            <img src='{{url('public/images/tenor.gif')}}'/>
        </div>
        <div class="col-md-12">
            <form id="productForm" action="{{url('admin/product/add')}}" method="post" enctype="multipart/form-data">
                @csrf
                ...
                <div class="text-center">
                    <input id="addColor" type="button" class="btn btn-info" name="addColor"
                           value="Add more color or size">
