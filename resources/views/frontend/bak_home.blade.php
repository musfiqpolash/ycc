                ...
                <div class="col-md-3 col-xs-6 imageBox leave_img">
                    <div class="imageBox box leave_img">
                        <img id="prdct{{$val[0]->id}}" class="img-thumbnail leave_img"
                             ...
                             onmouseenter="getProduct('{{$val[0]->group_name}}','prdct{{$val[0]->id}}')"
                             onmouseout="rmvPrdct('prdct{{$val[0]->id}}','{{url('public/uploads/assets/frontend/images/products/')}}/{{$val[0]->main_image}}')"
                             alt="1">
