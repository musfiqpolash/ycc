                ...
                <div class="col-md-12 productDetails">
                    ...
                    <form id="addToCartForm" action="{{url('/addToCart')}}">
                        ...
                        <div class="form-group">
                            ...
                            <input min="1" onblur="chk(this.id)" onchange="chk(this.id)" onkeyup="chk(this.id)" class="form-control" type="number" name="quantity" id="quantity" value="1">
                        </div>
                        <div class="row">
                            <div class="col-md-12">
